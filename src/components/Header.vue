...
<template>
      ...
      <ul class="hidden md:flex items-center space-x-10 text-xl">
        <li>
          <router-link
            ...
            active-class="font-bold text-white border-b-2 border-white"
            >Linha do Tempo</router-link
          >
        </li>
        <li class="relative" ref="componentesMenuRef">
          <button
            @click="isComponentesDropdownOpen = !isComponentesDropdownOpen"
            id="componentesBtn"
          ...
          <transition name="dropdown-fade">
            <div
              ...
              <ul class="text-lg text-center">
                <li>
                  <a
                    href="componentes/placamae.html"
                    class="nav-component-link block py-2 px-4 hover:bg-white/10 rounded-t-lg transition-all duration-300"
                    >Placa-Mãe</a
                  >
                </li>
                <li>
                  <a
                    href="componentes/processor.html"
                    class="nav-component-link block py-2 px-4 hover:bg-white/10 transition-all duration-300"
                    >Processador</a
                  >
                </li>
                <li>
                  <a
                    href="componentes/ram.html"
                    class="nav-component-link block py-2 px-4 hover:bg-white/10 transition-all duration-300"
                    >RAM</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="componentes/gabinete.html"
                    class="nav-component-link block py-2 px-4 hover:bg-white/10 transition-all duration-300"
                    >Gabinete</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="componentes/perifericos.html"
                    class="nav-component-link block py-2 px-4 hover:bg-white/10 rounded-b-lg transition-all duration-300"
                    >Periféricos</a
                  >
                </li>
              </ul>
  ...
  <div
    :class="{ 'opacity-0 scale-95 pointer-events-none': !isMobileMenuOpen }"
    id="mobileMenu"
    ...
    <ul class="text-2xl text-center space-y-6">
      ...
      <li>
        <button
          @click="isMobileComponentesOpen = true"
          id="mobileComponentesBtn"
  ...
  <div
    ...
    <div class="flex flex-col h-full">
      <div
        ...
        <button
          @click="isMobileComponentesOpen = false"
          id="closeMobileComponentesBtn"
      ...
      <div class="flex-1 p-6 overflow-y-auto">
        <div class="grid grid-cols-2 gap-4">
          <a
            ...
            <div class="mb-3">
              <svg
                class="w-12 h-12 mx-auto text-white/80"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24">
                <path
